...
import aboutus from "@/app/assets/aboutus.jpeg";
        ...
        >
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
            <div className="flex flex-1 flex-col space-y-2">
              <div className="flex justify-center"> <Image src={people} alt="People illustration" width={120} height={120} /></div>
            ...
            <div className="flex flex-1 flex-col space-y-2">
              <div className="flex justify-center"> <Image src={planet} alt="planet illustration" width={120} height={120}/></div>
            ...
            <div className="flex flex-1 flex-col space-y-2">
              <div className="flex justify-center"> <Image src={passion} alt="passion illustration" width={120} height={120}/></div>
