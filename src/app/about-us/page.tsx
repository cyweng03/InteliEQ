    ...
    <div className="pt-16">
      ...
      <div className="px-[10vw] my-6 space-y-12">
        ...
        >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
            <Profile
              image={<Image src={christianne} alt="Christianne" width={300} height={300} className="mx-auto rounded-full object-cover h-[300px] w-[300px] shrink-0 border-4 border-gray-300" />}
            ...
            />
            <Profile
              image={<Image src={karl} alt="Karl" width={300} height={300} className="mx-auto rounded-full object-cover object-[0%_0%] h-[300px] w-[300px] shrink-0 border-4 border-gray-300" />}
              name="Karl Selander"
              title="CTO"
...
"
            />
            <Profile
              image={<Image src={terry} alt="Terry" width={300} height={300} className="mx-auto rounded-full object-cover h-[300px] w-[300px] shrink-0 border-4 border-gray-300" />}
...
"
            />
            <Profile
              image={<Image src={jeff} alt="Jeff Miller" width={300} height={300} className="mx-auto rounded-full object-cover object-[50%_20%] h-[300px] w-[300px] shrink-0 border-4 border-gray-300" />}
              name="Jeff Miller"
            ...
            <Profile
              image={
                <Image
                  ...
                  width={300}
                  height={300}
                  className="mx-auto rounded-full object-cover object-[0%_-100%] h-[300px] w-[300px] shrink-0 border-4 border-gray-300"
                />
              }
            ...
            <Profile
              image={<Image src={william} alt="William Hatch" width={300} height={300} className="mx-auto rounded-full object-cover h-[300px] w-[300px] shrink-0 border-4 border-gray-300" />}
              name="William Hatch"
