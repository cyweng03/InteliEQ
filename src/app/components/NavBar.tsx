      ...
      <div className="container mx-auto px-4">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:flex space-x-8 text-sm font-semibold">
            ...
            <Link href="/solutions" className={`inline-flex items-center px-3 py-2 text-sm font-bold transition ${pathname === "/solutions" ? "text-brand-orange border-b-2 border-brand-orange" : "text-brand-white hover:text-brand-orange"}`}>
              Solutions For
            </Link>
