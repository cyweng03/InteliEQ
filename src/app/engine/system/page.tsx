  ...
  return (
    <div className="pt-16 ">
      ...
      <div className="container mx-auto space-y-2">
        ...
        <div className="type-lead font-bold">Turning Buildings Into Living, Intelligent Ecosystems</div>
        ...
        <div className="mt-16">
          ...
          <div className="type-kicker mt-3">Continuous Awareness. Continuous Action.</div>
        </div>
        ...
        <div className="mt-12">
          ...
          <div className="type-lead font-bold mt-4">
